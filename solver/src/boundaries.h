...
public:
  ...
  const OpposingBoundaries &operator[](size_t i) const {
    return boundaries_.at(i);
  }
...
At its most abstract implementation, a Boundary for the pressure
solution problem is a collcection
of nodes. It thus can either be an external or internal boundary of
the Model.
*/
