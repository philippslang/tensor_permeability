...
std::unique_ptr<csmp::PropertyDatabase<3>>
property_database(bool two_d = false);
...
inline bool is_main_boundary_id(std::string blname) {
  static const std::array<std::string, 12> outer = {
      "TOP",       "BOTTOM",    "LEFT",      "RIGHT",
      "FRONT",     "BACK",      "BOUNDARY1", "BOUNDARY2",
      "BOUNDARY3", "BOUNDARY4", "BOUNDARY5", "BOUNDARY6"};
